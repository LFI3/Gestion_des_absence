...
public class Gestion extends Fenetre {
    ...
    public Gestion(Rectangle r,String login,String password)
     {
...
//------------------------------------------------------------------------------       
        ...
        panel2.setBounds(10, 100, Parametre.x-30, Parametre.y-200);
...
//------------------------------------------------------------------------------        
        ...
        panel3.add(titre);
        panel3.setBounds(0, 0, Parametre.x-30, 40);
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------        
...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
        planingClasse.setIcon(new javax.swing.ImageIcon(getClass().getResource(cheminIcone+"classe.png"))); // NOI18N
...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
        planingSalle.setIcon(new javax.swing.ImageIcon(getClass().getResource(cheminIcone+"salle.png")));// NOI18N
        planingSalle.setBounds(20, 340, 60, 60);
//------------------------------------------------------------------------------        
//------------------------------------------------------------------------------
        planingEnseignant.setIcon(new javax.swing.ImageIcon(getClass().getResource(cheminIcone+"enseignant.png"))); // NOI18N
...
//------------------------------------------------------------------------------
         ...
         planingEnseignant.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
               ...
               setVisible(false);
               PlaningEnseignant pe=new PlaningEnseignant(getBounds(),login,password);
               pe.setVisible(true);
         ...
         planingSalle.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
               ...
               setVisible(false);
               PlaningSalle pe=new PlaningSalle(getBounds(),login,password);
               pe.setVisible(true);
         ...
         planingClasse.addActionListener(new java.awt.event.ActionListener() {
             public void actionPerformed(java.awt.event.ActionEvent evt) {
                 ...
                 setVisible(false);
                 PlaningClasse c = new PlaningClasse(getBounds(), login, password);
                 c.setVisible(true);
         ...
         ordinateur.addActionListener(new java.awt.event.ActionListener() {
             public void actionPerformed(java.awt.event.ActionEvent evt) {
                 ...
                 setVisible(false);
                 Reservation r = new Reservation(getBounds(), login, password);
                 r.setVisible(true);
         ...
         parametre.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                setVisible(false);
                view.Enseignant.ParametreEnseignant pe=new view.Enseignant.ParametreEnseignant(getBounds(),login,password);
                pe.setVisible(true);
