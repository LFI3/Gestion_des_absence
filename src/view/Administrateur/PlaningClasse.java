...
public class PlaningClasse extends Fenetre 

{

    public PlaningClasse(Rectangle r,String login1,String password1) 
    {
...
//------------------------------------------------------------------------------
        ...
        combo1.setModel(new javax.swing.DefaultComboBoxModel( nomClasse() ));
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------        
    ...
    {                                       
        int i=getNumero(combo1.getSelectedItem().toString());
