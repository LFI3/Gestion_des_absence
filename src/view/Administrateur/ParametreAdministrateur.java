...
import static modele.Administrateur.modifier;
import modele.Enseignant;
import modele.Theme;
import static modele.Theme.modifier;


public class ParametreAdministrateur extends javax.swing.JFrame 
{

    
    public String login1;
    public String password1;
    public ParametreAdministrateur(String login1,String password1)
...
//------------------------------------------------------------------------------
        ...
        setResizable(false);
        setTitle("Parametre d'administrateur");
//------------------------------------------------------------------------------
...
{ 
   setVisible(false);
   view.Administrateur.Gestion g=new view.Administrateur.Gestion(fenetre,login1,password);
   g.setVisible(true);
}
